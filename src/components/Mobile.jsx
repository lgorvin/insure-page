...
import intro2 from "../assets/images/image-intro-desktop.jpg";

const Mobile = () => {
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 duration-300">
        <div className="flex justify-center">
          <img className="md:hidden duration-300" src={intro} alt="" />
          <img
            className="hidden md:block lg:ml-[180px] duration-300"
            src={intro2}
            alt=""
          />
        </div>
        <div className="flex justify-center">
          <div className="float-left w-screen lg:mr-[140px] bg1 pb-28 duration-300">
            <svg
              className="mb-[-80px]"
            ...
            <div className="lg:mt-24 duration-300">
              <h1 className="text-5xl text-center my-4  heading m-2 text-white">
                Humanizing <br /> your insurance.
              </h1>
              <p className="text-center mx-2 text-white leading-6">
                Get your life insurance coverage easier and <br /> faster. We
                blend our expertise and <br /> technology to help you find the
                plan that's <br />
                right for you. Ensure you and your loved ones are protected.
              </p>
            </div>
            <div className="flex justify-center mt-10">
              <div className="border-2 p-1 px-4 group hover:bg-white border-white text-white cursor-pointer duration-300">
                <h1 className="text-sm text-center mt-2 group-hover:text-black duration-150">
                  VIEW PLANS
                </h1>
              </div>
            </div>
      ...
      <div className="absolute mt-[-150px] right-0">
      ...
      <div className="flex justify-center">
        <div className="bg-gray-200 rounded-sm mt-32 h-[3px] w-[200px]"></div>
      </div>
      <div>
        <h1 className="text-center mt-10 heading text-5xl">We're different</h1>
        ...
        <h1 className="text-center mt-6 heading text-3xl">Snappy Process</h1>
        <p className="text-center mt-3 mx-2 text-gray-400">
          Our application process can be completed in minutes, not hour. Don't
      ...
      <div>
        ...
        <h1 className="text-center mt-6 heading text-3xl">Affordable Prices</h1>
        <p className="text-center mt-3 mx-2 text-gray-400">
      ...
      <div>
        ...
        <h1 className="text-center mt-6 heading text-3xl">People First</h1>
        <p className="text-center mt-3 mx-2 text-gray-400">
      ...
      <div className="flex justify-center my-24">
        <div className="h-[400px] md:h-[300px] w-screen md:w-[80vw] my-5 mx-4 px-2 bg1 duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 px-5 md:px-20 md:pt-2 duration-300">
            <div>
              <h1 className="text-center text-white mt-10 sm:mt-24 md:mt-10 lg:mt-[85px] heading text-5xl duration-300">
                Find out more <br /> about how we work
              </h1>
            </div>
            <div className="flex justify-center items-center mt-10 md:mt-24 duration-300">
              <div className="border-2 p-1 px-4 group hover:bg-white border-white text-white duration-300">
                <h1 className="text-sm text-center mt-2 group-hover:text-black duration-150">
                  HOW WE WORK
                </h1>
              </div>
      ...
      <div className="flex justify-center">
        <div className="w-screen h-[1000px] md:h-[500px] bg2 duration-300">
          <div className="flex justify-center mt-20">
            ...
            {/* <svg
              className="absolute sm:hidden mt-[-80px]"
              xmlns="http://www.w3.org/2000/svg"
              width="374"
              height="173"
            >
            ...
            <svg
              className="hidden sm:block absolute left-0 mt-[-22px] scale-150"
              xmlns="http://www.w3.org/2000/svg"
              width="528"
              height="231"
            >
          ...
          <div className="flex justify-center mt-8">
            <div>
              ...
              >
                <path
                  className="hover:fill-black duration-300"
                  fill="#837D88"
          ...
          <div className="flex justify-center">
            <div className="w-screen h-[4px] mt-10 mx-8 rounded-md bg-gray-100"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4">
            <div>
              <div className="flex justify-center">
                <h1 className="text-gray-400 font1 mt-10">OUR COMPANY</h1>
              </div>
              <div className="">
                <h1 className="text-black text-center font2 mt-4 cursor-pointer">
                  HOW WE WORK
                </h1>
                <h1 className="text-black text-center font2 mt-3 cursor-pointer">
                  WHY INSURE?
                </h1>
                <h1 className="text-black text-center font2 mt-3 cursor-pointer">
                  CHECK PRICE
            ...
            <div>
              <div className="flex justify-center">
                <h1 className="text-gray-400 font1 mt-10">HELP ME</h1>
              </div>
              <div className="">
                <h1 className="text-black text-center font2 mt-4 cursor-pointer">
                  FAQ
            ...
            <div>
              <div className="flex justify-center">
                <h1 className="text-gray-400 font1 mt-10">CONTACT</h1>
              </div>
              <div className="">
                <h1 className="text-black text-center font2 mt-4 cursor-pointer">
                  SALES
            ...
            <div>
              <div className="flex justify-center">
                <h1 className="text-gray-400 font1 mt-10">OTHERS</h1>
              </div>
              <div className="">
                <h1 className="text-black text-center font2 mt-4 cursor-pointer">
                  CAREERS
